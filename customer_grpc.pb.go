...
type CustomersClient interface {
	GetCustomerByEmail(ctx context.Context, in *GetCustomerReq, opts ...grpc.CallOption) (*GetCustomerRes, error)
}
...
func (c *customersClient) GetCustomerByEmail(ctx context.Context, in *GetCustomerReq, opts ...grpc.CallOption) (*GetCustomerRes, error) {
	out := new(GetCustomerRes)
	err := c.cc.Invoke(ctx, "/parka_proto.Customers/GetCustomerByEmail", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type CustomersServer interface {
	GetCustomerByEmail(context.Context, *GetCustomerReq) (*GetCustomerRes, error)
...
func (UnimplementedCustomersServer) GetCustomerByEmail(context.Context, *GetCustomerReq) (*GetCustomerRes, error) {
...
func _Customers_GetCustomerByEmail_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetCustomerReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CustomersServer).GetCustomerByEmail(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/parka_proto.Customers/GetCustomerByEmail",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CustomersServer).GetCustomerByEmail(ctx, req.(*GetCustomerReq))
	}
...
var Customers_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "parka_proto.Customers",
	HandlerType: (*CustomersServer)(nil),
	Methods: []grpc.MethodDesc{
		{
			MethodName: "GetCustomerByEmail",
			Handler:    _Customers_GetCustomerByEmail_Handler,
		},
	},
